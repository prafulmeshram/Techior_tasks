...
public class QueryMaker {
	...
	public static final String CREATE_STUDENT_TABLE = "create table tab_student(student_id int PRIMARY KEY AUTO_INCREMENT, first_name varchar(50), last_name varchar(50), mobile_number varchar(15), email_id varchar(100), image_name varchar(100), reg_date varchar(10))";
	...
	public static final String STUDENT_INSERT = "insert into tab_student(first_name,last_name,mobile_number,email_id,image_name, reg_date)value(?,?,?,?,?,?)";
	public static final String STUDENT_LIST = "select * from tab_student";
	public static final String STUDENT_COUNT = "select count(*) as count from tab_student";
	public static final String STUDENT_LIST_PAGE = "SELECT * FROM tab_student ORDER BY student_id LIMIT ? OFFSET ?";
